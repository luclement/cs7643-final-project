...
def parse_args():
    ...
    parser.add_argument('--featex', type=str, default='vgg19', help='select feature extractor: vgg19, vgg16, resnet50, mobilenetv2, vgg16_keras or vgg19_keras. default=vgg19')
